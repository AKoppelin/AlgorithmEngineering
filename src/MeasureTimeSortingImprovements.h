...
Meter meterSortingTimeImpr = Meter();
cout << "Starting time measurements of improved sorting algorithms ..." << endl;
...
for (unsigned int i = 0; i <= 10000; i += (i/10 + 1)) {
    ...
    meterSortingTimeImpr.measureTime<void, std::vector<size_t> >(i, 10, "Quicksort1Ordered", quicksort1, vOrdered);
...
for (unsigned int i = 0; i <= 10000; i += (i/10 + 1)) {
    ...
    meterSortingTimeImpr.measureTime<void, std::vector<size_t> >(i, 10, "Quicksort1Reversed", quicksort1, vReversed);
...
for (unsigned int i = 0; i <= 10000; i += (i/10 + 1)) {
    ...
    meterSortingTimeImpr.measureTime<void, std::vector<size_t> >(i, 10, "Quicksort1Permuted", quicksort1, vPermuted);
...
for (unsigned int i = 0; i <= 10000; i += (i/10 + 1)) {
    ...
    meterSortingTimeImpr.measureTime<void, std::vector<size_t> >(i, 10, "Quicksort1Randomized", quicksort1, vRandomized);
...
for (unsigned int i = 0; i <= 10000; i += (i/10 + 1)) {
    ...
    meterSortingTimeImpr.measureTime<void, std::vector<size_t> >(i, 10, "Quicksort1Repeated", quicksort1, vRepeated);
...
for (unsigned int i = 0; i <= 10000; i += (i/10 + 1)) {
    std::vector<size_t> vOrdered = createOrderedVector(i);
    meterSortingTimeImpr.measureTime<void, std::vector<size_t> >(i, 10, "Quicksort2Ordered", quicksort2, vOrdered);
    vOrdered.erase(vOrdered.begin(), vOrdered.begin() + vOrdered.size());
}
cout << "Measuring function 'quicksort2' for reverse sorted input." << endl;
for (unsigned int i = 0; i <= 10000; i += (i/10 + 1)) {
    std::vector<size_t> vReversed = createReverseOrderedVector(i);
    meterSortingTimeImpr.measureTime<void, std::vector<size_t> >(i, 10, "Quicksort2Reversed", quicksort2, vReversed);
    vReversed.erase(vReversed.begin(), vReversed.begin() + vReversed.size());
}
cout << "Measuring function 'quicksort2' for permuted input." << endl;
for (unsigned int i = 0; i <= 10000; i += (i/10 + 1)) {
    std::vector<size_t> vPermuted = createPermutedVector(i);
    meterSortingTimeImpr.measureTime<void, std::vector<size_t> >(i, 10, "Quicksort2Permuted", quicksort2, vPermuted);
    vPermuted.erase(vPermuted.begin(), vPermuted.begin() + vPermuted.size());
}
cout << "Measuring function 'quicksort2' for randomized input." << endl;
for (unsigned int i = 0; i <= 10000; i += (i/10 + 1)) {
    std::vector<size_t> vRandomized = createRandomizedVector(i, 1);
    meterSortingTimeImpr.measureTime<void, std::vector<size_t> >(i, 10, "Quicksort2Randomized", quicksort2, vRandomized);
    vRandomized.erase(vRandomized.begin(), vRandomized.begin() + vRandomized.size());
}
cout << "Measuring function 'quicksort2' for input with repeated elements." << endl;
for (unsigned int i = 0; i <= 10000; i += (i/10 + 1)) {
    std::vector<size_t> vRepeated = createVectorWithRepeatedElements(i, 1);
    meterSortingTimeImpr.measureTime<void, std::vector<size_t> >(i, 10, "Quicksort2Repeated", quicksort2, vRepeated);
    vRepeated.erase(vRepeated.begin(), vRepeated.begin() + vRepeated.size());
}
...
for (unsigned int i = 0; i <= 10000; i += (i/10 + 1)) {
    std::vector<size_t> vOrdered = createOrderedVector(i);
    meterSortingTimeImpr.measureTime<void, std::vector<size_t> >(i, 10, "Quicksort3Ordered", quicksort3, vOrdered);
    vOrdered.erase(vOrdered.begin(), vOrdered.begin() + vOrdered.size());
}
cout << "Measuring function 'quicksort3' for reverse sorted input." << endl;
for (unsigned int i = 0; i <= 10000; i += (i/10 + 1)) {
    std::vector<size_t> vReversed = createReverseOrderedVector(i);
    meterSortingTimeImpr.measureTime<void, std::vector<size_t> >(i, 10, "Quicksort3Reversed", quicksort3, vReversed);
    vReversed.erase(vReversed.begin(), vReversed.begin() + vReversed.size());
}
cout << "Measuring function 'quicksort3' for permuted input." << endl;
for (unsigned int i = 0; i <= 10000; i += (i/10 + 1)) {
    std::vector<size_t> vPermuted = createPermutedVector(i);
    meterSortingTimeImpr.measureTime<void, std::vector<size_t> >(i, 10, "Quicksort3Permuted", quicksort3, vPermuted);
    vPermuted.erase(vPermuted.begin(), vPermuted.begin() + vPermuted.size());
}
cout << "Measuring function 'quicksort3' for randomized input." << endl;
for (unsigned int i = 0; i <= 10000; i += (i/10 + 1)) {
    std::vector<size_t> vRandomized = createRandomizedVector(i, 1);
    meterSortingTimeImpr.measureTime<void, std::vector<size_t> >(i, 10, "Quicksort3Randomized", quicksort3, vRandomized);
    vRandomized.erase(vRandomized.begin(), vRandomized.begin() + vRandomized.size());
}
cout << "Measuring function 'quicksort3' for input with repeated elements." << endl;
for (unsigned int i = 0; i <= 10000; i += (i/10 + 1)) {
    std::vector<size_t> vRepeated = createVectorWithRepeatedElements(i, 1);
    meterSortingTimeImpr.measureTime<void, std::vector<size_t> >(i, 10, "Quicksort3Repeated", quicksort3, vRepeated);
    vRepeated.erase(vRepeated.begin(), vRepeated.begin() + vRepeated.size());
}
