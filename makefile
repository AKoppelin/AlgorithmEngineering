...
CXX_UNITTEST_FLAG := -unittest
CXX_RELEASE_FLAG := -release
...
CXXFLAGS := $(CXX_STD_FLAG) $(CXX_INFORMATIONAL_WARNINGS_FLAG) $(CXX_WARNDEPRECATE_FLAG) $(CXX_SYMBOLICDEBUGINFO_FLAG) $(CXX_IMPORTPATH_FLAG)src/
